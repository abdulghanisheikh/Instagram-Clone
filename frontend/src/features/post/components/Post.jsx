...
const Post = ({user, post, handleLikes}) => {
    return <div className="post bg-zinc-900 flex flex-col gap-3 lg:py-4 py-2 w-full rounded-xl">
        ...
        <div className="bottom flex flex-col items-center w-full gap-3 px-7">
            <img className="w-full h-100 object-contain object-center rounded-lg" src={post.imageURL ? post.imageURL : `https://images.unsplash.com/photo-1772107756927-a3975482b1ef?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHw1fHx8ZW58MHx8fHx8`} alt="" />
