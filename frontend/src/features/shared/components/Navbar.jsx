...
const Navbar = ({page}) => {
    ...
    return <nav className="px-5 py-2 z-10 bg-white/10 backdrop-blur-sm w-[80%] rounded-lg justify-between fixed bottom-3 left-1/2 -translate-x-1/2 flex items-center">
